...
if [ -d ${BASE} ] && [ ! -w ${BASE} ] ; then
	...
	#	on UCSF, had to install OpenBLAS ( https://github.com/xianyi/OpenBLAS ) locally
	#
	...
	#
	#	then recompile Eigen with it
	#
	#	cd ~/github/jakewendt/HAWK/supplements/EIG6.0.1-Hawk/src/
	#	make OPENBLAS=/home/gwendt/.local/
	#	make install
	#	cd ~/github/jakewendt/HAWK/
	#	make install
	#
	#	then reinstall HAWK
