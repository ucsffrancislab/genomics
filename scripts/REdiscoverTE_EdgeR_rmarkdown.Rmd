...
#plot(pca_res, bg=color_p, labels= FALSE , pch=shape_p, col = "black")
#	"labels" is not a graphical parameter
#plot(pca_res$x, bg=color_p, pch=shape_p, col = "black")

autoplot(pca_res, data = normcounts, labels= FALSE )
...
pca_res <- prcomp(normcounts, scale. = TRUE)
#plot(pca_res, bg=color_p, labels= TRUE , pch=shape_p, col = "black")
#	"labels" is not a graphical parameter
#plot(pca_res, bg=color_p, pch=shape_p, col = "black")

autoplot(pca_res, data = normcounts, labels= TRUE )
```
