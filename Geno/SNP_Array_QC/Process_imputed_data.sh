...
indir=/francislab/data1/working/20210226-AGS-Mayo-Oncoarray/20210226-prep_for_imputation/imputation
scratchdir=$TMPDIR
outdir=/francislab/data1/working/20210226-AGS-Mayo-Oncoarray/20210303-for_analysis
...
#plink2 --vcf $indir/chr$chr.dose.vcf.gz dosage=DS --exclude $scratchdir/removesnps.txt --make-pgen --out $outdir/chr$chr.dose
