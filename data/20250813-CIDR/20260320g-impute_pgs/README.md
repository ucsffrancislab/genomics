...
#	20250813-CIDR/20260320g-impute_pgs
...
```BASH
impute_pgs.bash -f 0.8 -b hg19 -n 20260320-1kghg19-cidr-0.8 -a apps@ancestry@1.0.0 -r apps@1000g-phase-3-v5@2.0.0 work/cidr-updated-chr*.vcf.gz
```
...
mkdir pgs-cidr-hg19
cd pgs-cidr-hg19
curl -sL https://imputationserver.sph.umich.edu/get/zZl3EhETUuyEYgPbq1yQeFOZNKKHqHkGojKDyczs | bash
chmod -w *
cd ..
```
