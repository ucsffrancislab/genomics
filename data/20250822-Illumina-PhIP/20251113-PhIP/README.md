...
#	20250822-Illumina-PhIP/20251113-PhIP
...
```BASH
awk 'BEGIN{FS=OFS=","}(NR>1){print $6,$7,"/francislab/data1/working/20250822-Illumina-PhIP/20251113-downsample/out/"$1".VIR3_clean.id_upper_oligo.uniq.1-80.bam",$8,$9,$10,$13,$12,$26,$25}' /francislab/data1/raw/20250822-Illumina-PhIP/manifest.csv > manifest.all.csv
...
```BASH
awk 'BEGIN{FS=OFS=","}(NR>1){print $6,$7,"/francislab/data1/working/20250822-Illumina-PhIP/20251113-downsample/out/"$1".VIR3_clean.id_upper_oligo.uniq.1-80.bam",$8,$9,$10,$13,$12,$26,$25 > "manifest.plate"$26".csv" }' /francislab/data1/raw/20250822-Illumina-PhIP/manifest.csv
