...
echo -n "|    |"
for f in ${dir}/*_001.fastq.gz.read_count ; do
...
for f in ${dir}/*_001.fastq.gz.average_length ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo 
...
for f in ${dir}/*_001.trimmed.fastq.gz.read_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.fastq.gz.average_length ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.STAR.Aligned.toTranscriptome.out.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.STAR.Aligned.sortedByCoord.out.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.STAR.Aligned.sortedByCoord.out.bam.unaligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.STAR.Aligned.sortedByCoord.out.unmapped.fasta.gz.read_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
#	for f in ${dir}/*_001.trimmed.bowtie2.hg38.all.bam.aligned_count ; do
#	c=$(cat $f)
#	echo -n " ${c} |"
#	done
#	echo
...
for f in ${dir}/*_001.trimmed.bowtie2.hg38.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.STAR.mirna.Aligned.sortedByCoord.out.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.bowtie.mirna.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.bowtie2.mirna.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.bowtie2phiX.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.bowtie2salmonella.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
for f in ${dir}/*_001.trimmed.bowtie2burkholderia.bam.aligned_count ; do
c=$(cat $f)
echo -n " ${c} |"
done
echo
...
echo -n "| ${gene} |"
for f in ${dir}/*_001.trimmed.STAR.Aligned.toTranscriptome.out.bam.gene_count ; do
