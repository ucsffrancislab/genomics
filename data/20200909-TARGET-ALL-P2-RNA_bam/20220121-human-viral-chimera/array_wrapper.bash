...
OUT="/francislab/data1/working/20200909-TARGET-ALL-P2-RNA_bam/20220121-human-viral-chimera/out"
...
mkdir -p /francislab/data1/working/20200909-TARGET-ALL-P2-RNA_bam/20220121-human-viral-chimera/logs
date=$( date "+%Y%m%d%H%M%S" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --array=1-532%8 --job-name="viralchimera" --output="/francislab/data1/working/20200909-TARGET-ALL-P2-RNA_bam/20220121-human-viral-chimera/logs/array.${date}-%A_%a.out" --time=4320 --nodes=1 --ntasks=8 --mem=60G --gres=scratch:250G /francislab/data1/working/20200909-TARGET-ALL-P2-RNA_bam/20220121-human-viral-chimera/array_wrapper.bash
