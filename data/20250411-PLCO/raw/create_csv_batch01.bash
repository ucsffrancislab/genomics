...
#  Type: Grayscale
	...
	colortype=$( identify -verbose out/${base}/${base}-${ci}-cropped.png | grep "  Type: " )
	echo -n ",${colortype}"
...
for txt in out/batch[1]_spot_plots_human_IgG_0?.raw.txt ; do
	#echo $txt
...
#	so only need to do half, but somehow need to account for the B&W images in the counting
