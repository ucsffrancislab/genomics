...
#while read batch pdf_file color_png_file bw_png text1 text2 text3 text4 text5 Overall_max Overall_mean Overall_std Overall_kurtosis Overall_skewness Red_max Red_mean Red_std Red_kurtosis Red_skewness Green_max Green_mean Green_std Green_kurtosis Green_skewness Blue_max Blue_mean Blue_std Blue_kurtosis Blue_skewness ; do
echo "<tr>"
echo "<td>${protein}</td>"
...
echo "</tr>"
done < <( tail -n +2 slurm-607421.out | head -5880 | tr ',' '\t' )
