...
if(nrow(metal_results) > 0) {
  ...
  # Cap extreme values at 350 (represents p < 1e-350)
  n_extreme <- sum(metal_plot$neglog10p > 350, na.rm = TRUE)
  metal_plot$neglog10p <- pmin(metal_plot$neglog10p, 350)
  ...
  if(n_extreme > 0) {
    cat("  Extreme values capped:", n_extreme, "associations with p < 1e-350 (shown at y=350)\n\n")
  } else {
    cat("\n")
  }
