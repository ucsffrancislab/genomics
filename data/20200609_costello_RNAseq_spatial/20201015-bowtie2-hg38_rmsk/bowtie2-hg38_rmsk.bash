...
DIR="/francislab/data1/working/20200609_costello_RNAseq_spatial/20201015-bowtie2-hg38_rmsk/out"
mkdir -p ${DIR}
...
for r1 in ${INDIR}/455*_R1.fastq.gz ; do
...
#while IFS=, read -r r1 ; do
	...
	if [ -f $f ] && [ ! -w $f ] ; then
		...
		#	Always use our server. The communal ones are just too slow. Starts first. Finishes last.
...
#		fi
	...
	done	#	for g in ';Family=Alu:' ';Class=LINE;' ; do
