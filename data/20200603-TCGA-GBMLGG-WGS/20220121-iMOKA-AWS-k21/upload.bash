...
BOX="https://dav.box.com/dav/Francis _Lab_Share/20200603-TCGA-GBMLGG-WGS/20220121-iMOKA-AWS-k21"
curl -netrc -X MKCOL "${BOX}/"
...
for k in 21 ; do
	for s in 80a 80b 80c ; do
		BOX="https://dav.box.com/dav/Francis _Lab_Share/20200603-TCGA-GBMLGG-WGS/20220121-iMOKA-AWS-k21/IDH.${k}.${s}"
		curl -netrc -X MKCOL "${BOX}/"
		...
		for f in IDH.${k}.${s}/aggregated.* IDH.${k}.${s}/iMOKA* IDH.${k}.${s}/matrix* IDH.${k}.${s}/reduced* IDH.${k}.${s}/output.json IDH.${k}.${s}/output_fi.tsv IDH.${k}.${s}/output_predictions.tsv ; do
			echo $f
			#curl -netrc -T IDH.${k}.${s}/${f} "${BOX}/"
			curl -netrc -T ${f} "${BOX}/"
		done

		BOX="https://dav.box.com/dav/Francis _Lab_Share/20200603-TCGA-GBMLGG-WGS/20220121-iMOKA-AWS-k21/IDH.${k}.${s}/output_models"
		curl -netrc -X MKCOL "${BOX}/"
		for f in IDH.${k}.${s}/output_models/* ; do
			echo $f
			curl -netrc -T ${f} "${BOX}/"
		done
	done
