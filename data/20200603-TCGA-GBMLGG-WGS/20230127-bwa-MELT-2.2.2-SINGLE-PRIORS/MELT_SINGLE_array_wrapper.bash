...
OUT="/francislab/data1/working/20200603-TCGA-GBMLGG-WGS/20230127-bwa-MELT-2.2.2-SINGLE-PRIORS/out"
...
#mei=ALL
	...
	if [ -f $f ] && [ ! -w $f ] ; then
		...
		java -Xmx6G -jar ${MELTJAR} Single -k \
			...
			-t /c4/home/gwendt/.local/MELTv2.2.2/me_refs/Hg38/sva_list_with_priors.txt \
			-w $( dirname ${f} ) \
			-r ${ave_read_length}
