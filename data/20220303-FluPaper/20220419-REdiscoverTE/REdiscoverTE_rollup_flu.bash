...
#		echo "${trimmer}.k${k}"
		...
		ls -1 ${INDIR}/*${suffix}.salmon.REdiscoverTE.k${k}/quant.sf \
		...
		sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL \
			...
			--output="${PWD}/logs/REdiscoverTE.${date}.rollup${suffix}.out" \
			--time=4320 --nodes=1 --ntasks=64 --mem=495G \
			${PWD}/REdiscoverTE_rollup${suffix}.bash \
