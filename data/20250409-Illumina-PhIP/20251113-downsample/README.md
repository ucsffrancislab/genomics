...
#	20250409-Illumina-PhIP/20251113-downsample
...
samtools_downsample_array_wrapper.bash --iterations 5 --read_count 750000 --outdir ${PWD}/out/ ${PWD}/../20250410-bowtie2/out/S*bam
