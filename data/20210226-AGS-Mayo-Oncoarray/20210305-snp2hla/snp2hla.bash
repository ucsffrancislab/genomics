...
for windowsize in 100 1000 ; do
	...
	sbatch --job-name=Mayo-${windowsize} --time=999 --ntasks=8 --mem=250G \
	...
	sbatch --job-name=mMayo-${windowsize} --time=999 --ntasks=8 --mem=250G \
...
#	at a.a.a(Unknown Source)
#	Guessing its a memory issue
#
#for windowsize in 10000 ; do
#
#	sbatch --job-name=Mayo-${windowsize} --time=999 --ntasks=8 --mem=500G \
#		--output=${PWD}/imputed/snp2hla.${windowsize}.output.${date}.txt \
#		--export=NONE \
#		~/.local/bin/SNP2HLA.bash \
#			${PWD}/chr6.annotated \
...
#
#		#	${PWD}/../20210304-snp2hla/chr6-t1dgc-matched \
#	sbatch --job-name=mMayo-${windowsize} --time=999 --ntasks=8 --mem=400G \
#		--output=${PWD}/matchedimputed/snp2hla.${windowsize}.output.${date}.txt \
#		--export=NONE \
#		~/.local/bin/SNP2HLA.bash \
#			${PWD}/chr6-t1dgc-matched.filtered \
