...
#for r1 in ${DIR}/????_R1.fastq.gz ; do
	...
	paste <( zcat ${r1} ) <( zcat ${r2} ) \
		| grep -f /scratch/gwendt/tmp/ASS_filtered_down_kmers.txt -B 1 -A 2 --no-group-separator \
		| awk -F"\t" \
			-v lr1=/francislab/data1/working/20200407_Schizophrenia/20200617-post_metago/out/$( basename ${r1} .gz ) \
			-v lr2=/francislab/data1/working/20200407_Schizophrenia/20200617-post_metago/out/$( basename ${r2} .gz ) \
