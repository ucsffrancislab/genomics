...
dir="/francislab/data1/working/20211208-EV/20220913-iMOKA"	#/out"
...
if [ "${step}" == "random_forest" ] ; then
	...
	#	change ....... to something smaller than the smallest group count?
...
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="${PWD}/iMOKA.${date}.out" --time=14400 --nodes=1 --ntasks=64 --mem=495G ${PWD}/iMOKA.bash --dir ${PWD}/16 --k 16 --step create
