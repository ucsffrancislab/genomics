...
rawdir=/francislab/data1/raw/20211208-EV/fastq
...
for s in ${samples} ; do
	...
	study=$( awk -v s=$s 'BEGIN{FS="\t";OFS=" "}($1==s){print $5,$6,$7}' /francislab/data1/raw/20211208-EV/adapter\ and\ indexes\ for\ QB3_NovaSeq\ SP\ 150PE_SFHH009\ S\ Francis_11-16-2021.tsv )
