...
dir="/francislab/data1/working/20211208-EV/20211214-iMOKA"	#/out"
...
cp /francislab/data1/working/20211208-EV/20211214-iMOKA/config.json ${WORKDIR}/
...
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20211208-EV/20211214-iMOKA/iMOKA.${date}.out" --time=14400 --nodes=1 --ntasks=64 --mem=499G /francislab/data1/working/20211208-EV/20211214-iMOKA/iMOKA.bash --dir /francislab/data1/working/20211208-EV/20211214-iMOKA/21 --k 21


date=$( date "+%Y%m%d%H%M%S" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20211208-EV/20211214-iMOKA/iMOKA.${date}.out" --time=14400 --nodes=1 --ntasks=64 --mem=499G /francislab/data1/working/20211208-EV/20211214-iMOKA/iMOKA.bash --dir /francislab/data1/working/20211208-EV/20211214-iMOKA/31 --k 31


date=$( date "+%Y%m%d%H%M%S" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20211208-EV/20211214-iMOKA/iMOKA.${date}.out" --time=14400 --nodes=1 --ntasks=64 --mem=499G /francislab/data1/working/20211208-EV/20211214-iMOKA/iMOKA.bash --dir /francislab/data1/working/20211208-EV/20211214-iMOKA/41 --k 41


date=$( date "+%Y%m%d%H%M%S" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20211208-EV/20211214-iMOKA/iMOKA.${date}.out" --time=14400 --nodes=1 --ntasks=64 --mem=499G /francislab/data1/working/20211208-EV/20211214-iMOKA/iMOKA.bash --dir /francislab/data1/working/20211208-EV/20211214-iMOKA/11 --k 11 --step reduce
