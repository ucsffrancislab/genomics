...
cp /costellolab/data3/jocostello/LG3/exomes_recal/*/germline/*snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/GBM02/germline/GBM02.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/GBM05-Z385/germline/GBM05.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/GBM06/germline/GBM06.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/Patient303/germline/Patient303.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/Patient375/germline/Patient375.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/Patient469/germline/Patient469.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/Patient470/germline/Patient470.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/Patient486/germline/Patient486.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/Patient516.new/germline/Patient516.UG.snps.vcf{,.idx} ./vcfs/
...
cp -f /costellolab/data3/jocostello/LG3/exomes_recal/Patient83/germline/Patient83.UG.snps.vcf{,.idx} ./vcfs/
