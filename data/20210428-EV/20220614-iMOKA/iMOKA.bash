...
dir="/francislab/data1/working/20210428-EV/20220614-iMOKA"	#/out"
...
cp /francislab/data1/working/20210428-EV/20220614-iMOKA/config.json ${WORKDIR}/
...
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20210428-EV/20220614-iMOKA/iMOKA.${date}.out" --time=720 --nodes=1 --ntasks=64 --mem=495G /francislab/data1/working/20210428-EV/20220614-iMOKA/iMOKA.bash --dir /francislab/data1/working/20210428-EV/20220614-iMOKA/16 --k 16 --source_file ${PWD}/source.GBMWT.tsv


date=$( date "+%Y%m%d%H%M%S%N" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20210428-EV/20220614-iMOKA/iMOKA.${date}.out" --time=720 --nodes=1 --ntasks=64 --mem=495G /francislab/data1/working/20210428-EV/20220614-iMOKA/iMOKA.bash --dir /francislab/data1/working/20210428-EV/20220614-iMOKA/21 --k 21 --source_file ${PWD}/source.GBMWT.tsv


date=$( date "+%Y%m%d%H%M%S%N" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20210428-EV/20220614-iMOKA/iMOKA.${date}.out" --time=720 --nodes=1 --ntasks=64 --mem=495G /francislab/data1/working/20210428-EV/20220614-iMOKA/iMOKA.bash --dir /francislab/data1/working/20210428-EV/20220614-iMOKA/31 --k 31 --source_file ${PWD}/source.GBMWT.tsv
