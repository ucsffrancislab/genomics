...
for fastq in ${rawdir}/SFHH005*fastq.gz ; do
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.fastq.gz.read_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.fastq.gz.average_length.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.STAR.hg38.Aligned.toTranscriptome.out.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| STAR Aligned to Transcriptome % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.STAR.hg38.Aligned.toTranscriptome.out.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.STAR.hg38.Aligned.sortedByCoord.out.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| STAR Aligned to Genome % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.STAR.hg38.Aligned.sortedByCoord.out.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.STAR.hg38.Aligned.sortedByCoord.out.bam.unaligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| STAR Unaligned % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.STAR.hg38.Aligned.sortedByCoord.out.bam.unaligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.STAR.hg38.Aligned.sortedByCoord.out.unmapped.fasta.gz.read_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| STAR Unmapped % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.STAR.hg38.Aligned.sortedByCoord.out.unmapped.fasta.gz.read_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.hg38.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to hg38 (1) % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.hg38.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.STAR.mirna.Aligned.sortedByCoord.out.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| STAR Aligned to mirna % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.STAR.mirna.Aligned.sortedByCoord.out.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie.mirna.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie Aligned to mirna % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie.mirna.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.mirna.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to mirna % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.mirna.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.rmsk.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to RMSK % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.rmsk.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.phiX.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to phiX % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.phiX.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.salmonella.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to Salmonella % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.salmonella.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.salmonella.masked.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to masked Salmonella % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.salmonella.masked.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.burkholderia.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to Burkholderia % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.burkholderia.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.burkholderia.masked.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to masked Burkholderia % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.burkholderia.masked.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
...
for s in ${samples} ; do for t in ${trimmers} ; do
	c=$(cat ${dir}/${s}.umi.${t}.bowtie2.mRNA_Prot.bam.aligned_count.txt 2> /dev/null)
	echo -n " ${c} |"
done ; done
echo
...
echo -n "| Bowtie2 Aligned to mRNA_Prot % |"
for s in ${samples} ; do for t in ${trimmers} ; do
	f=${dir}/${s}.umi.${t}.bowtie2.mRNA_Prot.bam.aligned_count.txt
	n=$(cat ${f} 2> /dev/null)
