...
IN="/francislab/data1/working/20200720-TCGA-GBMLGG-RNA_bam/20200803-bamtofastq/out"
OUT="/francislab/data1/working/20200720-TCGA-GBMLGG-RNA_bam/20220103-viral-chimera/out"
...
date=$( date "+%Y%m%d%H%M%S" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --array=1 --job-name="viralchimera" --output="/francislab/data1/working/20200720-TCGA-GBMLGG-RNA_bam/20220103-viral-chimera/logs/array.${date}-%A_%a.out" --time=4320 --nodes=1 --ntasks=8 --mem=60G --gres=scratch:250G /francislab/data1/working/20200720-TCGA-GBMLGG-RNA_bam/20220103-viral-chimera/array_wrapper.bash
