...
BOX="https://dav.box.com/dav/Francis _Lab_Share/20200720-TCGA-GBMLGG-RNA_bam/20220524-iMOKA"
curl -netrc -X MKCOL "${BOX}/"

#for f in metadata.cart.TCGA.GBM-LGG.WGS.bam.2020-07-17.csv TCGA.Glioma.metadata.tsv ; do
for f in TCGA.Glioma.metadata.tsv ; do
	echo $f
	curl -netrc -T ${f} "${BOX}/"
done
...
for k in 11 21 31 ; do
	for s in 80a 80b 80c ; do
		BOX="https://dav.box.com/dav/Francis _Lab_Share/20200720-TCGA-GBMLGG-RNA_bam/20220524-iMOKA/IDH.${k}.${s}"
		curl -netrc -X MKCOL "${BOX}/"
