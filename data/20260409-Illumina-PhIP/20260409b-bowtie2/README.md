...
#	20260409-Illumina-PhIP/20260409b-bowtie2
...
bowtie2_array_wrapper.bash --single --threads 8 --sort --very-sensitive \
  ...
  ${PWD}/../20260409a-cutadapt/out/*fastq.gz
```
...
Wait until have proper manifest with all the details then ...
...
module load r
./read_counts.Rmd
box_upload.bash reports.csv reports.t.csv read_counts.html
```
