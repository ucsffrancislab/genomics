...
\rm ${R_INPUT}.mismatch
\rm ${R_INPUT}.nosex
\rm ${R_INPUT}.select_samples
\rm ${R_INPUT}.unique_ids
\rm ${R_INPUT}.valid.sample
\rm ${R_INPUT}.vcf.gz
ls -l ${R_INPUT}.*
```
...
/francislab/data1/working/20240918-MeningiomaGWAS/20250506-prep_for_imputation/imputed/chr22.fam.
Not sure why.
