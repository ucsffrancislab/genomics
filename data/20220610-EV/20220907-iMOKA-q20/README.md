...
#	20220610-EV/20220907-iMOKA-q20
...
RAW=${PWD}/raw
mkdir -p $RAW
for f in ${DIR}/*.quality20.format.umi.t1.t2.t3.notphiX.readname.hg38.rx.marked.deduped.fa.gz ; do
l=$( basename $f .quality20.format.umi.t1.t2.t3.notphiX.readname.hg38.rx.marked.deduped.fa.gz )
