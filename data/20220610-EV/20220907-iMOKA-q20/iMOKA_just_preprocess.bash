...
dir="/francislab/data1/working/20220610-EV/20220907-iMOKA-q20"	#/out"
...
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="${PWD}/logs/iMOKA_just_preprocess.${date}.out" --time=2880 --nodes=1 --ntasks=64 --mem=495G ${PWD}/iMOKA_just_preprocess.bash --dir ${PWD}/16 --k 16


date=$( date "+%Y%m%d%H%M%S%N" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="${PWD}/logs/iMOKA_just_preprocess.${date}.out" --time=2880 --nodes=1 --ntasks=64 --mem=495G ${PWD}/iMOKA_just_preprocess.bash --dir ${PWD}/21 --k 21


date=$( date "+%Y%m%d%H%M%S%N" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="${PWD}/logs/iMOKA_just_preprocess.${date}.out" --time=2880 --nodes=1 --ntasks=64 --mem=495G ${PWD}/iMOKA_just_preprocess.bash --dir ${PWD}/31 --k 31
