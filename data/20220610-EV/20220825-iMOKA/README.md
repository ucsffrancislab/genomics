...
#	20220610-EV/20220825-iMOKA


UMI content filtered

ONLY reads with repeated UMIs
...
RAW=${PWD}/raw
mkdir -p $RAW
for f in ${DIR}/*.quality.umi.t1.t3.umifiltered-repeatedumi.hg38-nonrandomized.umi_filter.marked.fa.gz ; do
l=$( basename $f .quality.umi.t1.t3.umifiltered-repeatedumi.hg38-nonrandomized.umi_filter.marked.fa.gz )
