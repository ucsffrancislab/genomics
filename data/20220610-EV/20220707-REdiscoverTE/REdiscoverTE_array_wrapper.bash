...
OUT="/francislab/data1/working/20220610-EV/20220707-REdiscoverTE/out"
...
fasta=$( ls -1 ${IN}/*.quality.umi.t1.t3.hg38.rx.marked.reference.fasta.gz | sed -n "$line"p )
echo $fasta
...
base=$( basename ${fasta} .quality.umi.t1.t3.hg38.rx.marked.reference.fasta.gz )
