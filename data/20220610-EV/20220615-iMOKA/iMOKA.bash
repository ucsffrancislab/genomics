...
dir="/francislab/data1/working/20220610-EV/20220615-iMOKA"	#/out"
...
cp /francislab/data1/working/20220610-EV/20220615-iMOKA/config.json ${WORKDIR}/
...
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20220610-EV/20220615-iMOKA/iMOKA.${date}.out" --time=2880 --nodes=1 --ntasks=64 --mem=495G /francislab/data1/working/20220610-EV/20220615-iMOKA/iMOKA.bash --dir /francislab/data1/working/20220610-EV/20220615-iMOKA/16 --k 16


date=$( date "+%Y%m%d%H%M%S%N" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20220610-EV/20220615-iMOKA/iMOKA.${date}.out" --time=2880 --nodes=1 --ntasks=64 --mem=495G /francislab/data1/working/20220610-EV/20220615-iMOKA/iMOKA.bash --dir /francislab/data1/working/20220610-EV/20220615-iMOKA/21 --k 21


date=$( date "+%Y%m%d%H%M%S%N" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20220610-EV/20220615-iMOKA/iMOKA.${date}.out" --time=2880 --nodes=1 --ntasks=64 --mem=495G /francislab/data1/working/20220610-EV/20220615-iMOKA/iMOKA.bash --dir /francislab/data1/working/20220610-EV/20220615-iMOKA/31 --k 31



date=$( date "+%Y%m%d%H%M%S%N" )
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --job-name="iMOKA" --output="/francislab/data1/working/20220610-EV/20220615-iMOKA/iMOKA.${date}.out" --time=2880 --nodes=1 --ntasks=64 --mem=495G /francislab/data1/working/20220610-EV/20220615-iMOKA/iMOKA.bash --dir /francislab/data1/working/20220610-EV/20220615-iMOKA/11 --k 11 --step reduce
