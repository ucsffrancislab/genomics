...
basedir=/francislab/data2/working/20220610-EV/20220615-iMOKA


modelbase=/francislab/data2/working/20210428-EV/20210706-iMoka
...
for k in 15 20 25 30 35 ; do
	...
	ddir=${basedir}/${k}
	mdir=${modelbase}/${k}.cutadapt2.GBMWT
