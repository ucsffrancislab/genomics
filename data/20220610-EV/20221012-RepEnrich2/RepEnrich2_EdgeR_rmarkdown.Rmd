...
#	FAILS as design levels is NULL
#	Quitting from lines 181-195 (RepEnrich2_EdgeR_rmarkdown.Rmd) 
#	Error in if (levels[1] == "(Intercept)") { : argument is of length zero
#	Calls: <Anonymous> ... eval_with_user_handlers -> eval -> eval -> makeContrasts
