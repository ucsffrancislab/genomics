...
#	20220610-EV/20220907-iMOKA-q25
...
RAW=${PWD}/raw
mkdir -p $RAW
for f in ${DIR}/*.quality25.format.umi.t1.t2.t3.notphiX.readname.hg38.rx.marked.deduped.fa.gz ; do
l=$( basename $f .quality25.format.umi.t1.t2.t3.notphiX.readname.hg38.rx.marked.deduped.fa.gz )
