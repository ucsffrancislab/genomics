...
RAW=${PWD}/raw
mkdir -p $RAW
for f in ${DIR}/*.quality.umi.t1.t3.hg38.rx.marked.reference.rmsk.fagz ; do
l=$( basename $f .quality.umi.t1.t3.hg38.rx.marked.reference.rmsk.fagz )
