...
#	20201006-GTEx/20240705-TEProF2_v25
...
TEProF2_array_wrapper.bash --threads 4 \
  ...
  /francislab/data1/working/20201006-GTEx/20240618-STAR_twopass_basic-hg38_v25/out/*.Aligned.sortedByCoord.out.bam
...
awk 'BEGIN{FS="\t";OFS=","}(NR==1){print "Transcript,GTEx 1438"}(NR>1){c=0;for(i=2;i<=NF;i++){c+=$i};print $1,c}' presence2.tsv > counts2.csv
