...
#for accession in */*sra ; do
	echo $accession
	base=${accession%.sra}
	f=${base}_1.fastq

	#cd $( dirname ${accession} )
	...
	if [ -f $f ] && [ ! -w $f ] ; then
		...
		fastq-dump --split-e --ngc ${basedir}/prj_20942_D10852.ngc --outdir ${accession} ${accession}
		chmod a-w ${base}*fastq
	fi
...
#	shift
#done
done < ${basedir}/PairedBrainRNASRAAccessions.txt.head
