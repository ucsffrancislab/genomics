...
```{python clustermap}
g = sns.clustermap(df,
	col_colors=pd.concat([ col_colors2, col_colors3, col_colors4],axis=1),
...
#	ORDER MATTERS
plt.subplots_adjust(top=0.95,bottom=0.15, left=0.01, right=0.8)
...
g.ax_cbar.set_position([0.05, 0.02, 0.71, 0.02]) # [left, bottom, width, height]
