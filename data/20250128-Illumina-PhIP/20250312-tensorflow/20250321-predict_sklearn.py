...
RFclf = RandomForestClassifier(n_estimators = 1000000, verbose = 1, n_jobs=4)
#RFclf = RandomForestRegressor(n_estimators = 10000)
...
#	
#	layer1 = Dropout(0.1)(Dense(int(len(x_columns)/2), activation=activation)(Dropout(0.1)(Dense(len(x_columns), activation=activation)(encoded_els))))
#	
