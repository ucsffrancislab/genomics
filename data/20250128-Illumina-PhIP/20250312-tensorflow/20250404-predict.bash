...
#	protein=${species_and_protein#*,}
	...
	echo "export SPECIES='${s}'; export ACTIVATION=${activation}; export TEST_SIZE=${test_size}; export RANDOM_STATE=${random_state}; export LOOP_NUMBER=${i}; export OUT_DIR=${PWD}/20250407/; ${PWD}/${f}.py"
...
#	./20250404-predict.bash > commands
