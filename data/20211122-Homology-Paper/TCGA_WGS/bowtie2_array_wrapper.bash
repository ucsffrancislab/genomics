...
dir="/francislab/data1/working/20211122-Homology-Paper/TCGA_WGS/aligned"
...
sample=$( sed -n "$line"p /francislab/data1/working/20211122-Homology-Paper/TCGA_WGS/TCGA_normal_samples.txt )
echo $sample
...
wc -l /francislab/data1/working/20211122-Homology-Paper/TCGA_WGS/TCGA_normal_samples.txt
126
...
sbatch --mail-user=$(tail -1 ~/.forward)  --mail-type=FAIL --array=1-126%8 --job-name="align" --output="${PWD}/TCGA_WGS/logs/bowtie2.${date}-%A_%a.out" --time=1440 --nodes=1 --ntasks=8 --mem=60G /francislab/data1/working/20211122-Homology-Paper/TCGA_WGS/bowtie2_array_wrapper.bash
