...
IN=/francislab/data1/raw/20200303_GPMP_DNA/fastq
OUT=/francislab/data1/working/20200303_GPMP_DNA/20200306-full/trimmed
mkdir -p ${OUT}
		...
		bbduk_id=$( qsub -N ${jobbase}.bbduk -l nodes=1:ppn=2 -l vmem=32gb \
			...
			~/.local/bin/bbduk.bash \
				-F "-Xmx16g \
					...
					ref=/francislab/data1/refs/illumina_adapters.fa \
					ktrim=r \
					k=23 \
					mink=11 \
					hdist=1 \
