...
INDIR="/francislab/data1/working/20210604-GPMP-GBM/20210622-hkle-trim-chimera/101"
OUTDIR="/francislab/data1/working/20210604-GPMP-GBM/20210622-hkle-trim-chimera/out"
mkdir -p ${OUTDIR}
...
for r1 in ${INDIR}/SF*.R1.fastq.gz ; do
	echo ${r1}
