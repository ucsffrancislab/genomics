...
# Load data
print("Loading data...")
peptide_enriched = pd.read_csv("Glioma_PLCO_VZV_CaseControl/results/peptide_enrichment_binary.csv", index_col=0)
...
os.makedirs('Glioma_PLCO_VZV_CaseControl/results/case_control', exist_ok=True)
...
# Save results
results.to_csv('Glioma_PLCO_VZV_CaseControl/results/case_control/peptide_results.csv', index=False)
print(f"Saved results to: Glioma_PLCO_VZV_CaseControl/results/case_control/peptide_results.csv")
...
analyzer.create_volcano_plot(
    results, 
    level_name='peptide',
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/volcano_peptide.png'
)
...
analyzer.create_heatmap(
    ...
    results,
    top_n=50,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/heatmap_peptides.png'
)
...
analyzer.create_enrichment_distribution(
    ...
    metadata_subjects,
    case_col='status',
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/enrichment_distribution.png'
)
...
analyzer.create_prevalence_barplot(
    ...
    top_n=20,
    level_name='peptide',
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/prevalence_peptides.png'
)
...
analyzer.create_roc_curve(
    ...
    metadata_subjects,
    top_n=10,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/roc_curve.png'
)
...
analyzer.create_venn_diagram(
    ...
    metadata_subjects,
    case_col='status',
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/venn_diagram.png'
)
...
analyzer.create_effect_size_plot(
    results,
    top_n=30,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/effect_sizes.png'
)
...
analyzer.create_cumulative_prevalence(
    ...
    results,
    case_col='status',
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/cumulative_prevalence.png'
)
...
analyzer.create_violin_plot(
    ...
    metadata_subjects,
    case_col='status',
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/violin_plot.png'
)
...
analyzer.create_peptide_correlation_heatmap(
    ...
    results,
    top_n=50,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/peptide_correlations.png'
)
...
analyzer.create_manhattan_plot(
    results,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/manhattan_plot_all.png'
)
...
analyzer.create_manhattan_plot(
    results,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/manhattan_plot_HHV3.png',
...
analyzer.create_manhattan_plot(
    results,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/manhattan_plot_HHV4.png',
...
analyzer.create_manhattan_plot(
    results,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/manhattan_plot_HHV5.png',
...
analyzer.create_manhattan_plot(
    results,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/manhattan_plot_VZV.png',
    organism_filter='Human herpesvirus 3'
)
...
analyzer.create_prevalence_comparison_plot(
    results,
    top_n=30,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/prevalence_comparison.png'
)
...
analyzer.create_upset_plot(
    ...
    case_col='status',
    top_n=20,
    output_file='Glioma_PLCO_VZV_CaseControl/results/case_control/upset_plot.png'
)

print("\n" + "="*70)
print("ANALYSIS COMPLETE!")
print("="*70)
print("\nOutput files in Glioma_PLCO_VZV_CaseControl/results/case_control/:")
