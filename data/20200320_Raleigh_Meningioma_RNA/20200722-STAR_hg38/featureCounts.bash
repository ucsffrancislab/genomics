...
~/.local/bin/featureCounts.bash -T 64 -a $gtf -t feature -g feature_name -o ${outbase}.csv /francislab/data1/working/20200320_Raleigh_Meningioma_RNA/20200722-STAR_hg38/out/*.STAR.hg38.Aligned.out.bam > ${outbase}.${date}.out.txt 2>&1
