...
```{r}
ggplot( r[r$Plate==2,], aes(Well.X, Well.Y, fill=Raw.Read.Count)) + 
  scale_fill_gradientn(colors=c('black','blue','white'),limits=c(1200000,2800000)) +
  geom_tile() + ggtitle("Plate 2")
```

```{r}
ggplot( r[r$Plate==14,], aes(Well.X, Well.Y, fill=Raw.Read.Count)) + 
  scale_fill_gradientn(colors=c('black','blue','white'),limits=c(1200000,2800000)) +
  geom_tile() + ggtitle("Plate 14")
```


```{r}
ggplot( r[r$Plate==2,], aes(Well.X, Well.Y, fill= Q40.Unique.Aligned.Tile.Count)) + 
...
```{r}
ggplot( r[r$Plate==14,], aes(Well.X, Well.Y, fill= Q40.Unique.Aligned.Tile.Count)) + 
  scale_fill_gradientn(colors=c('black','blue','white'),limits=c(10000,102000)) +
  geom_tile() + ggtitle("Plate 14")
